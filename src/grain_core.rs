...
*/
    ...
    fn test_load_non_null() {
        ...
        // Init and load keys into the cipher
        let cipher = GrainCore::new(to_test_vector(0x000102030405060708090a0b0c0d0e0fu128, 16), to_test_vector(0x000102030405060708090a0bu128, 12));
